...
const rows = [
  { id: "date", disablePadding: true, label: "Session Date" },
  { id: "client", disablePadding: true, label: "Client" },
  { id: "duration", disablePadding: true, label: "Session Length (min)" },
  { id: "therapist", disablePadding: true, label: "Therapist" },
  { id: "actual_cost", disablePadding: true, label: "Session Cost" },
  { id: "payment", disablePadding: true, label: "Payment" },
...
class AccountDetailsTable extends React.Component {
  ...
  async componentDidMount() {
    const accountDetailsResp = await API.get("/accounts/accountdetails");
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">{n.actual_cost}</TableCell>
                      </TableRow>
                    );
                  })}
                {emptyRows > 0 && (
